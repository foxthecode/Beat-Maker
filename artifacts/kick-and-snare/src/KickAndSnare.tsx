...
const DRUM_KITS=[
  ...
  {id:"lofi",     name:"Lo-Fi",        icon:"📼",
   samples:{kick:`${import.meta.env.BASE_URL}samples/lofi/kick.wav`,snare:`${import.meta.env.BASE_URL}samples/lofi/snare.wav`,hihat:`${import.meta.env.BASE_URL}samples/lofi/hihat.wav`,clap:`${import.meta.env.BASE_URL}samples/lofi/clap.wav`,tom:`${import.meta.env.BASE_URL}samples/lofi/tom.wav`,ride:`${import.meta.env.BASE_URL}samples/lofi/ride.wav`,crash:`${import.meta.env.BASE_URL}samples/lofi/crash.wav`,perc:`${import.meta.env.BASE_URL}samples/lofi/perc.wav`},
   shape:{sDec:0.8, sTune:0.9,  sPunch:0.7, sSnap:0.5, sBody:1.15,sTone:0.65}},
  {id:"electro",  name:"Electronic",   icon:SVG_LAUNCHPAD,
   samples:{kick:`${import.meta.env.BASE_URL}samples/electronic/kick.wav`,snare:`${import.meta.env.BASE_URL}samples/electronic/snare.wav`,hihat:`${import.meta.env.BASE_URL}samples/electronic/hihat.wav`,clap:`${import.meta.env.BASE_URL}samples/electronic/clap.wav`,tom:`${import.meta.env.BASE_URL}samples/electronic/tom.wav`,ride:`${import.meta.env.BASE_URL}samples/electronic/ride.wav`,crash:`${import.meta.env.BASE_URL}samples/electronic/crash.wav`,perc:`${import.meta.env.BASE_URL}samples/electronic/perc.wav`},
